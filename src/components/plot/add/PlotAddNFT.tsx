...
import { Button, CardStep, Select, Flex, Loading } from '@mint/core';
import {
  Box,
  Grid,
  FormControl,
  ...
  if (showCreatePlotNFT) {
    return (
      <PlotNFTSelectPool
        ...
        description={
          <Trans>
            Join a pool and get consistent XKM farming rewards. The average
    ...
    >
      ...
      {!loading && !hasNFTs && (
        <>
          <Typography variant="subtitle1">
            <Trans>
              Join a pool and get more consistent XKM farming rewards. Create a
