...
import { CardStep, Select } from '@mint/core';
import {
  FormControl,
  FormHelperText,
  Grid,
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    // Sort mintpos to the top of the list
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Mint Proof of Space plotter. If unsure,
            use the default Mint Proof of Space plotter.
        </Trans>
      </Typography>
